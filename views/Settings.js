...
import { View, ScrollView, Text, StyleSheet, Image, TouchableOpacity, Linking, Alert, Platform } from "react-native";
import { ChevronRight, NotepadText, Landmark, LogOut, Palette, Bell, Link, Envelope } from "../assets/icons/Icons";
...
const MenuItem = memo(({ icon: Icon, title, subtitle, onPress, colors, styles, iconColor = colors.regular100, rightIconColor = colors.regular700 }) => (
    <TouchableOpacity style={styles.pageItem} onPress={onPress}>
      <View style={styles.pageContent}>
        <View style={[styles.pageIcon, iconColor !== colors.regular100 && { backgroundColor: iconColor }]}>
          <Icon
        ...
        <View>
          <Text style={[styles.pageTitle, iconColor !== colors.regular100 && { color: iconColor }]}>
            {title}
          </Text>
        ...
        <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
          <View style={styles.sectionPageContainer}>
            ...
            {menuItems.map((section, sectionIndex) => (
                <View key={`section-${sectionIndex}`} style={styles.sectionPageItem}>
