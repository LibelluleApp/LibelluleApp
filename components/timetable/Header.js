    ...
    return (
        <View style={styles.headerContainer}>
            ...
            <View style={styles.centerContent}>
                ...
                <Text style={[styles.dayText, isToday && styles.todayDate]}>{dayOfWeek}</Text>
                <Text style={[styles.dateNumberText, isToday && styles.todayDate]}>{day}</Text>
            </View>
            </View>
...
const getWeekNumber = (date) => {
    ...
    const daysSinceFirst = Math.floor((currentDate - firstDayOfYear) / (24 * 60 * 60 * 1000));
